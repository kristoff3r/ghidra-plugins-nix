  ...
  outputs =
    ...
    flake-utils.lib.eachSystem [ "x86_64-linux" ] (
      ...
      let
        ...
        plugins = {
          # gameboy = pkgs.callPackage ./plugins/gameboy.nix { };
          nes = pkgs.callPackage ./plugins/nes.nix { };
          snes = pkgs.callPackage ./plugins/snes.nix { };
          wasm = pkgs.callPackage ./plugins/wasm.nix { inherit sleigh; };
        };

        processors = {
          irisc = pkgs.callPackage ./processors/irisc.nix { };
        };
          ...
          ghidra.overrideAttrs (
            ...
            let
              ...
              processorsDir = pkgs.symlinkJoin {
                ...
                paths = lib.attrsets.attrValues processors;
              };
            in
            {
              preFixup =
